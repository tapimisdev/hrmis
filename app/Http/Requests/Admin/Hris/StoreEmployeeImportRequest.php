...
class StoreEmployeeImportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'employees.*.bio_id'                        => ['nullable', 'unique:employee_information,biometrics_id'],
            'employees.*.date_hired_organization'       => ['required', 'date', 'before_or_equal:today'],
            'employees.*.date_hired_company'            => ['required', 'date', 'before_or_equal:today'],
            ...
            'employees.*.salary_grade'                  => ['required', 'numeric'],
