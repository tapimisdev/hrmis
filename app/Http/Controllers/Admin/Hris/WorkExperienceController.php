...
class WorkExperienceController extends Controller
{
    ...
    public function index(Request $request, ? string $employee_no = null)
    {
        ...
        return view('admin.pages.hris.work-experience', compact('isEdit', 'id', 'isExists', 'employee_no'));
    ...
    public function handleFile(string $employee_no, object $file) {
        ...
        $file->storeAs(
            'users/' . $employee_no .  '/pds' . '/work-experience', 
            $filename, 
            'public'
        );   
    ...
    public function save(string $employee_no, Request $request) {
        ...
        $validator = Validator::make($payload, [
            ...
            'isGovernment' => 'required|in:yes,no',
        ...
        try {
            ...
            $exists = DB::table('employee_work_experience')
                ->where('id', $payload['id'])
            ...
            $data = [
                ...
                'salary_pay_grade'  => $payload['salary_pay_grade'],
                'employment_status'  => $payload['employment_status'],
                'isGovernment'  => $payload['isGovernment'] == 'yes' ? true : false,
                'updated_at' => now(),
                'created_at' => now(),
            ];
            ...
            DB::table('employee_work_experience')->updateOrInsert(
                [
                    'id'          => $payload['id'],
