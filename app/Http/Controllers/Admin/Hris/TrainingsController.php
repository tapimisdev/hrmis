...
class TrainingsController extends Controller
{
    ...
    public function index(Request $request, ? string $employee_no = null)
    {
        ...
        return view('admin.pages.hris.trainings', compact('isEdit', 'id', 'isExists', 'employee_no'));
    }
    ...
    public function save(string $employee_no, Request $request) {
        ...
        try {
            ...
            $exists = DB::table('employee_trainings')
                ->where('id', $payload['id'])
            ...
            DB::table('employee_trainings')->updateOrInsert(
                [
                    'id'          => $payload['id'],
