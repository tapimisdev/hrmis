<x-modal id="myModal" title="Special Order Application" size="modal-lg">
    <div class="p-4 pt-0" style="font-family: Arial, sans-serif;">
        <div class="text-center">
            <h4 class="text-muted text-uppercase fw-bold">Special Order No: <span id="doc-id"></span></h4>
        </div>
