...
<div class="container-fluid min-vh-100">
    ...
    <x-header-employee title="Local Travel Order / Apply" subtitle="Create local travel order application in this module">
    ...
    <div class="card rounded-3 mb-5">
        <div class="card-header fw-bold d-flex align-items-center text-uppercase py-3">
            <div class="d-flex justify-content-between align-items-center w-100">
                <div>
                    <i class="fa-solid fa-file-lines me-2"></i> Local Travel Order Application Form
                </div>
            </div>
        </div>
        <form method="POST" action="{{ route('lto.store') }}" id="form" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-8 mb-3">
                        <label for="lto_no" class="form-label fw-semibold">Local Travel No. <span class="text-danger">*</span></label>
                        <input type="text" name="lto_no" id="lto_no" class="form-control">
                        <div class="error-field"></div>
                    </div>
                </div>
