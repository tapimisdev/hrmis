...
<div class="container-fluid">
    ...
    <x-header title="Local Travel Order Application" subtitle="View local travel order application details">
        <x-button-link
            href="{{ route('services.lto.index') }}"
    ...
    <form id="form" action="{{ route('services.lto.save', ['application' => $data->id]) }}" method="POST">
        @csrf
        @method('POST')
