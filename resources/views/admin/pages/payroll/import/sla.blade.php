...
@section('content')
    <div class="container-fluid">
        <x-header title="Import SLA Payroll Registry" subtitle="Upload previous SLA payroll registry">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body py-5 px-4">
                    <form id="form" enctype="multipart/form-data" action="{{ route('registry.sla.store') }}" method="post">
                        @method('POST')
                        @csrf
                        <div class="row">
