...
@section('content')
    <div class="container-fluid">
        <x-header title="Import Longevity Payroll Registry" subtitle="Upload previous longevity payroll registry">
        ...
        <div class="container">
            <div class="card">
                ...
                <div class="card-body py-5 px-4">
                    <form id="form" enctype="multipart/form-data" action="{{ route('registry.longevity.store') }}" method="post">
                        @method('POST')
                        @csrf
                        <div class="row">
...
$(function() {
    ...
    function parseForm() {
        ...
        $.ajax({
            ...
            contentType: false,
            beforeSend: function() {
                $btn.prop('disabled', true).html('<span class="spinner-border spinner-border-sm me-2"></span>Parsing...');
            },
            ...
            ? `
                <div class="alert alert-danger mt-3 mb-0">
                    ...
                    ${remainingErrors.length > 0 ? `
                        <button class="btn btn-sm btn-outline-danger mt-3 d-inline-block" type="button" data-bs-toggle="collapse" data-bs-target="#more-parse-issues" aria-expanded="false" aria-controls="more-parse-issues">
    ...
    function createDynamicTable(data, previewHeaders = {}, fieldOrder = null, errors = []) {
        let table = `<div class="excel-table-wrapper table-responsive"><table id="dynamic-table" class="excel-table"><thead><tr class="header-labels">`;
        ...
        data.forEach(row => {
            ...
            table += `<td class="text-center align-middle"><button type="button" class="btn btn-sm btn-outline-danger delete-preview-row" title="Delete row"><i class="fa-solid fa-trash"></i></button></td>`;
            ...
            headers.forEach(header => {
                ...
                const isInvalidField = isMissingEmployeeNo || isMissingName || isUnknownEmployeeNo || isInactiveEmployee;
    ...
    function clearFields() {
        ...
        $('#form').find('input[type="month"], input[type="file"]').val('');
    }
