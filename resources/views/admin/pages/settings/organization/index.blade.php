        ...
        <x-header title="Organization" subtitle="Manage your organization settings here">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu">
                    <li>
                        <a class="dropdown-item" href="{{ route('organization.create', ['type' => 'division']) }}">
                            New Division
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item" href="{{ route('organization.create', ['type' => 'unit']) }}">
                            New Unit
                        </a>
                    </li>
                </ul>
            ...
            <div class="card-body">
                <ul class="nav nav-tabs mb-3" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button data-id="agency" class="push-state-query toggle-datatable nav-link text-uppercase fw-bold px-4 py-3 active" id="all-tab" data-bs-toggle="tab" data-bs-target="#agency" type="button" role="tab">
                            Agency
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button data-id="division" class="push-state-query toggle-datatable nav-link text-uppercase fw-bold px-4 py-3" id="all-tab" data-bs-toggle="tab" data-bs-target="#division" type="button" role="tab">
                            Divisions
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button data-id="unit" class="push-state-query toggle-datatable nav-link text-uppercase fw-bold px-4 py-3" id="active-tab" data-bs-toggle="tab" data-bs-target="#unit" type="button" role="tab">
                            Units
                        </button>
                    </li>
                </ul>
