                        ...
                        <table class="table table-bordered mt-3">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" style="width: 300px" class="form-control text-uppercase text-center" placeholder="First Name">
                                        <div class="error-field"></div>
                                    </td>
                                    <td>
                                        <input type="text" style="width: 300px" class="form-control text-uppercase text-center" placeholder="Middle Name">
                                        <div class="error-field"></div>
                                    </td>
                                    <td>
                                        <input type="text" style="width: 300px" class="form-control text-uppercase text-center" placeholder="Last Name">
                                        <div class="error-field"></div>
                                    </td>
                                    <td>
                                        <input type="date" style="width: 300px" class="form-control text-uppercase text-center">
                                        <div class="error-field"></div>
                                    </td>
                                    <td>
