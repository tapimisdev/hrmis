                    ...
                    <div class="accordion">
                        <div class="accordion-item">
                            <h2 class="accordion-header">
                                <button class="accordion-button text-uppercase fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-trainings" aria-expanded="false" aria-controls="flush-trainings">
                                    Trainings and Programs Attended
                                </button>
                            </h2>
                            <div id="flush-trainings" class="accordion-collapse collapse show">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form" enctype="multipart/form-data" action="{{route('hris.employee.trainings', ['employee_no' => $employee_no])}}" method="post">
                        @if($isEdit)
                            @method('PUT')
                        @else
                            @method('POST')
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-12 mb-3">
                                ...
                                <input type="number" id="consumed_hours" name="consumed_hours" class="form-control text-uppercase"
                                    value="">
                                <div class="error-field"></div>
                            </div>
                            <div class="col-12 col-md-12 mb-3">
                                <label class="mb-2" for="type">
                                    Type of LD (Managerial / Supervisory / Technician / etc )
                                </label>
                                <input type="text" id="type" name="type" class="form-control text-uppercase"
                                    value="">
                                <div class="error-field"></div>
                            </div>
                            <div class="col-12 col-md-12 mb-3">
                                <label class="mb-2" for="sponsored_by">Conducted / Sponsored By</label>
                                <input type="text" id="sponsored_by" name="sponsored_by" class="form-control text-uppercase"
                                    value="">
                                <div class="error-field"></div>
                            </div>
                            <div class="col-12 col-md-12 mb-3">
...
<script>
    $(function() {
        ...
        let = DataTable = $('#myTable').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                url: '{{ route('api.employee.trainings') }}',
                data: function (d) {
                    d.isDT = true;
            ...
            "columns": [
                ...
                { data: "sponsored_by", name: 'sponsored_by' },
