                    ...
                    <div class="card border shadow-sm">
                        <div class="card-body text-center p-4">
                            <div class="position-relative d-inline-block mb-3">
                                ...
                                />
                                <label
                                    class="profile-upload btn btn-sm btn-light text-dark shadow"
                                >
...
import ShowDevicesModal from "./ShowDevicesModal.vue";
        ...
        async loadProfile() {
            try {
                ...
                if (data.personal.profile)
                    this.profilePreview = data.personal.profile;
            } catch (e) {
