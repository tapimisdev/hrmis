<template>
    <div
        class="chart-card position-relative shadow-sm border border-body-secondary"
    >
        <div
            v-if="loading"
            class="position-absolute h-100 w-100 d-flex justify-content-center align-items-center bg-body-secondary z-3"
            style="left: 0"
        >
