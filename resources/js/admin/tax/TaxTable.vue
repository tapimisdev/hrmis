      ...
      <table class="table table-hover mb-0 compact-table">
        <thead>
          <tr>
            ...
            <th class="sticky-header text-end gradient-text">TOTAL</th>
            <th class="sticky-header text-end text-muted-light" v-for="month in months" :key="month">{{ month }}</th>
          </tr>
        </thead>
        <tbody>
...
.custom-scrollbar::-webkit-scrollbar-track { background: var(--bs-body-secondary); }
.custom-scrollbar::-webkit-scrollbar-thumb { background: var(--bs-primary); border-radius:10px; }
