    ...
    <TwoColLayout>
        ...
        <template #left>
            <TaxComulativeFilters
                ...
                @compute-cumulative="computeComulative"
...
import TaxComulativeTable from "./TaxComulativeTable.vue";
import TaxComulativeFilters from "./TaxComulativeFilters.vue";
...
export default {
    ...
    data() {
        return {
            ...
            // tabs
            periods: [
                { key: "Q2", label: "Q2", sub: "Apr–Jun • Cum." },
                { key: "Q3", label: "Q3", sub: "Jul–Sep • Cum." },
                { key: "NOV", label: "Adj. Cum.", sub: "Oct–Nov • Bonus" },
                { key: "FINISH", label: "Year-End", sub: "Dec • Final" },
            ],
    ...
    computed: {
        ...
        divisions() {
            const set = new Set(
                this.rows.map((r) => r.division).filter(Boolean),
            );
    ...
    methods: {
        ...
        computeComulative() {
            console.log(
                "PULL FROM PAYROLL & RECONCILE for period:",
                this.activePeriod,
            );
        },
