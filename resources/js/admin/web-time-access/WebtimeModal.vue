                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <div>
                            <h5 class="modal-title mb-0">
                                Schedule Web Time Access
                            </h5>
                            <small class="text-muted d-block"
                                >Set when selected employees can use web
                                time-in/out.</small
                            >
                        </div>
                    </div>
                    ...
                    <div class="selected-box mb-3">
                      <!-- Error Summary -->
                        ...
                        <div v-else class="empty-selected">
                            ...
                            No employees selected. Select employees first to
                            apply a schedule.
                        </div>
                    </div>
                    ...
                    <form @submit.prevent="submitSchedule">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted d-block mt-2"
                                >Choose one rule. Switching type clears the
                                previous selection.</small
                            >
                            <span
                                v-if="errors.type"
                        ...
                        >
                            ...
                            <div>
                                ...
                                <small class="d-block"
                                    >Selected employees will be allowed to use
                                    web time-in/out anytime.</small
                                >
                            </div>
                        </div>
                        ...
                        <div v-if="form.type === 'days_of_week'" class="mb-3">
                            ...
                            >
                            <span
                                v-if="errors.days_of_week"
                                class="text-danger d-block mt-1"
                                >{{ errors.days_of_week[0] }}</span
                            >
                        </div>
                        ...
                        <div v-if="form.type === 'specific_dates'" class="mb-3">
                            ...
                            <div class="d-flex gap-2">
                                <input
                                    ...
                                    class="form-control"
                                    :class="{
                                        'is-invalid': errors.specific_dates,
                                    }"
                                    v-model="newDate"
                                    :min="minDate"
                                    :disabled="loading"
                            ...
                            <div class="mt-3">
                                <div
                                    v-if="!form.specific_dates.length"
                                    class="empty-state"
                                >
                            ...
                            <span
                                v-if="errors.specific_dates"
                                class="text-danger d-block mt-1"
                                >{{ errors.specific_dates[0] }}</span
                            >
                        </div>
...
export default {
    name: "ScheduleModal",
    props: { selected_ids: { type: Array, default: () => [] } },
    data() {
        return {
            ...
            errorMessage: "",
            newDate: "",
            form: { type: "", days_of_week: [], specific_dates: [] },
        };
    },
    computed: {
        minDate() {
    ...
    methods: {
        ...
        reset() {
            this.form = { type: "", days_of_week: [], specific_dates: [] };
            this.newDate = "";
            this.errors = {};
            this.errorMessage = ""; // ✅ this was missing in your reset
            this.loading = false;
        },
        onTypeChange() {
            this.errors = {};
        ...
        toggleWeekDay(day) {
            this.errors.days_of_week && delete this.errors.days_of_week;
            const i = this.form.days_of_week.indexOf(day);
            i >= 0
                ? this.form.days_of_week.splice(i, 1)
                : this.form.days_of_week.push(day);
        },
        addSpecificDate() {
            this.errors.specific_dates && delete this.errors.specific_dates;
        ...
        removeSpecificDate(i) {
            this.form.specific_dates.splice(i, 1);
            this.errors.specific_dates && delete this.errors.specific_dates;
        },
        validateClient() {
            this.errors = {};
            ...
            if (!this.selected_ids?.length)
                return (this.errorMessage = "No employees selected.");
            if (!this.form.type)
                return (this.errors.type = ["Please choose a schedule type."]);
            if (
                this.form.type === "days_of_week" &&
                !this.form.days_of_week.length
            )
                return (this.errors.days_of_week = [
            ...
            if (
                ...
                return (this.errors.specific_dates = [
        ...
        handleError(err) {
            ...
            if (!err.response)
                return (this.errorMessage = "Network error. Please try again.");
