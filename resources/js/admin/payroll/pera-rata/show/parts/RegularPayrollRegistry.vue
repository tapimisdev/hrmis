        ...
        <div class="excel-sheet">
            ...
            <div class="sheet-header">
                ...
                <h1 class="sheet-title mb-3">
                  PAYROLL OF PERA and RATA FOR THE MONTH OF {{ month }}
                </h1>
            </div>
                ...
                <table class="excel-table">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="text-center">{{ emp.pera }}</td>
                            <td class="text-center">{{ emp.representation_allowance }}</td>
                            <td class="text-center">{{ emp.transportion_allowance }}</td>
                            <td class="text-center">
                                {{ emp.absences }}
                            </td>
                            <td class="text-center">{{ emp.ut_deductions }}</td>
                    ...
                    <tfoot>
                        <tr class="grand-total text-center">
                            ...
                            <td class="number-cell">
                               {{ formatNumber(grandTotals("pera")) }}
                            </td>
                            <td class="number-cell">
                                {{ formatNumber(grandTotals("representation_allowance")) }}
                            </td>
                            <td class="number-cell">
                                {{ formatNumber(grandTotals("transportion_allowance")) }}
                            </td>
                            <td class="number-cell">
                                {{ formatNumber(grandTotals("absences")) }}
                            </td>
                            <td class="number-cell">
                            ...
                            <td class="number-cell">
                                {{ formatNumber(grandTotals("adjustments")) }}
                            </td>
                            <td class="number-cell">
