                ...
                >
                    <div class="accordion-body">
                        ...
                        >
                            ...
                            >
                                <div
                                    class="d-flex align-items-start gap-3 w-100"
                                >
                                    <!-- Checkbox -->
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <div
                                            v-for="(remark, rIndex) in employee.remarks"
                                            :key="rIndex"
                                        >
                                            <a
                                                v-if="remark.value != 0"
                                    ...
                                    <!-- Badge (keep your UI, but make it reflect employee.selected like the 2nd file) -->
                                    <span
