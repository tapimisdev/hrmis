...
export default {
    ...
    methods: {
        ...
        async fetchRegistry() {
            try {
                const response = await axios.get(`/api/payroll/longevity-pay/${this.payroll_id}`, {
                    headers: {
        ...
        `,
            ...
            try {
                await axios.delete(`/api/payroll/longevity-pay/${emp.id}/${this.employment_type}`, {
