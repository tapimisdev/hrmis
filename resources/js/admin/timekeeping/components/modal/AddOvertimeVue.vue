                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            required
                        />
                        <span class="text-danger" v-if="errors.start_time">{{
                            errors.start_time[0]
                        }}</span>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input
                            ...
                            required
                        />
                        <span class="text-danger" v-if="errors.end_time">{{
                            errors.end_time[0]
                        }}</span>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        computetotal_hours() {
            ...
            const [startHour, startMinute] = this.form.start_time
                .split(":")
                .map(Number);
            const [endHour, endMinute] = this.form.end_time
                .split(":")
                .map(Number);
