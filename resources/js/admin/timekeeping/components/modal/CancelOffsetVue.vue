<template>
    <div class="modal-body">
        <div class="modal-confirm">
            ...
            <p>
                Are you sure you want to cancel this employee's <strong><span class="text-uppercase">Approved</span></strong> Offset?
                <hr>
...
export default {
    ...
    methods: {
        ...
        async cancel() {
            ...
            try {
                const res = await axios.post("/api/cancel-offset", form, {
                    headers: {
                ...
                Swal.fire({
                    title: "Offset Cancelled",
                    text: "The employee's offset has been successfully cancelled.",
                    icon: "success",
                }).then(() => {
