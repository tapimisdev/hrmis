<template>
    <div class="modal-body">
        <div class="modal-confirm">
            ...
            <p>
                Are you sure you want to cancel this employee's <strong><span class="text-uppercase">Approved</span></strong> Local Travel Order?
            </p>
...
export default {
    ...
    methods: {
        ...
        async cancel() {
            ...
            try {
                const res = await axios.post("/api/cancel-lto", form, {
                    headers: {
                ...
                Swal.fire({
                    title: "LTO Cancelled",
                    text: "The employee's local travel order has been successfully cancelled.",
                    icon: "success",
                }).then(() => {
