        ...
        <form @submit.prevent="submitLogs">
            <div class="row">
                ...
                <div class="col-md-4">
                    <FormSkeletonVue v-if="initial_loading" :rows="1" :columns="1"/>
                    <div v-else class="mb-3">
                        <label class="form-label">Weekly Schedule <span class="text-danger">*</span></label>
                        <select v-model="form.weeklyschedule"
                            class="form-select"
                        ...
                        <span class="text-danger" v-if="errors.weeklyschedule">{{ errors.weeklyschedule[0] }}</span>
                    </div>
                </div>
