<template>
  <div class="modal-body">
    <div class="modal-confirm">
      ...
      <p>Do you confirm marking this employee as absent on {{ formattedDate }}?</p>

      <div class="modal-confirm-footer">
        <button @click="markAsAbsent()" class="btn py-3 px-4 btn-primary">
...
export default {
  ...
  methods: {
    ...
    async markAsAbsent() {
      ...
      try {
        const res = await axios.post('/api/mark-as-absent', form, {
          headers: {
        ...
        Swal.fire({
          title: "Marked Absent",
          text: "The employee has been successfully marked as absent.",
          icon: "success",
        }).then(() => {
