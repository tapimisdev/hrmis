    ...
    <div class="container-fluid d-flex justify-content-md-between">
        ...
        <div class="dropdown">
            <a class="nav-link text-capitalize d-flex align-items-center gap-2" href="" role="button">
                <img class="mini-logo" src="<?php echo e(asset('img/dost-tapi.png')); ?>" alt="">

                <?php echo e(config('app.client')); ?>
...
<?php /**PATH /var/www/html/resources/views/admin/components/navbar.blade.php ENDPATH**/ ?>